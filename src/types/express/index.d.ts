...
import {UserRequest} from "types/express/ClientRequest"
...
declare module "knex/types/tables" {
    ...
    interface Tables {
        ...
        users_composite: Knex.CompositeTableType<// This interface will be used for return type and
            ...
            Pick<User, "full_name"> & Partial<Pick<User, "created_at" | "updated_at">>,
